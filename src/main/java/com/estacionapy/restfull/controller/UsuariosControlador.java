...
public class UsuariosControlador {
	...
	public ResponseEntity<Usuarios> getCategoriaUsuariosById(@PathVariable(value="id") Long usuarioId) 
    ...
    public ResponseEntity<Usuarios> updateEmployee(@PathVariable(value = "id") Long usuarioId,
